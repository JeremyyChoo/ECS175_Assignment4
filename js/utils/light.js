...
class DirectionalLight extends Light {
    ...
    getCamera( scale )
    {
        ...
        // Compute light direction by transforming a default direction vector
        let dir = vec3.transformQuat(vec3.create(), [0.0, -1.0, 0.0], transform);

        // Compute light position by using the translation part of the model matrix
        let eye = vec3.fromValues(this.model_matrix[12], this.model_matrix[13], this.model_matrix[14]);
